...
function calValidDistance(e, t, i, a, o) {
  ...
  return (
    0 <= t
      ? ((r = 0), e.event.trigger('scrollLeft'))
      : Math.abs(t) >= l - n && ((r = n - l), e.event.trigger('scrollRight')),
    r
  )
}
    ...
    t.clientX
      ? i.rotate
        ? ((o = i.height - t.clientX * i.pixelRatio),
          (e =
            (t.pageY - a.currentTarget.offsetTop - (i.height / i.pixelRatio / 2) * (i.pixelRatio - 1)) * i.pixelRatio))
...
function findCurrentIndex(e, t, i, a) {
  ...
  let r = []
  if (0 < t.length) {
    if ('candle' == i.type) for (let e = 0; e < t[0].length; e++) r.push(t[0][e][0].x)
    else for (let e = 0; e < t[0].length; e++) r.push(t[0][e].x)
    ;('line' == i.type || 'area' == i.type) && 'justify' == i.xAxis.boundaryGap && (l = i.chartData.eachSpacing / 2),
      i.categories || (l = 0),
      isInExactChartArea(e, i, a) &&
...
function findFunnelChartCurrentIndex(e, t) {
  for (var a, o = -1, n = 0, l = t.series.length; n < l; n++)
    if (
      ((a = t.series[n]),
      e.x > a.funnelArea[0] && e.x < a.funnelArea[2] && e.y > a.funnelArea[1] && e.y < a.funnelArea[3])
    ) {
      o = n
      break
    }
...
function calLegendData(e, t, i, a) {
  ...
  if ('top' == t.legend.position || 'bottom' == t.legend.position) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      n + l > t.width - t.padding[1] - t.padding[3]
        ? (a.push(g), p.push(n - t.legend.itemGap), (n = l), (g = [i]))
        : ((n += l), g.push(i))
    }
    if (g.length) {
    ...
    if (((l.points = g), g.length)) {
      for (let e = 0; e < g.length; e++) {
        ...
        for (let e, o = 0; o < i.length; o++)
          (e = h + x + measureText(i[o].name || 'undefined', d) + t.legend.itemGap), e > a && (a = e)
...
function getXAxisTextList(e, t) {
  ...
  if (
    ...
    -1 < n
      ...
      : ('number' === typeof t.xAxis.min && (s = a(t.xAxis.min, s)),
        'number' === typeof t.xAxis.max && (d = o(t.xAxis.max, d))),
    s === d)
  ) {
    var h = d || 10
    d += h
...
function calXAxisData(e, t, i) {
  ...
  return (
    r + 2 * i.xAxisTextPadding > n &&
      ((a.angle = (45 * Math.PI) / 180), (a.xAxisHeight = 2 * i.xAxisTextPadding + r * Math.sin(a.angle))),
  ...
  for (let n = 0; n < a.length; n++) {
    ...
    ;(r.color = o.color),
      ...
      o.data.forEach(function(a, o) {
        ...
        ;(n.angle = e[o]),
          (n.proportion = a / s),
          (n.position = convertCoordinateOrigin(
            i * n.proportion * l * Math.cos(n.angle),
            i * n.proportion * l * Math.sin(n.angle),
            t
          )),
          r.data.push(n)
      }),
...
function getRoseDataPoints(e, t, a, o) {
  ...
  for (let n, r = 0; r < e.length; r++)
    (n = e[r]), (n.data = null === n.data ? 0 : n.data), (l += n.data), s.push(n.data)
...
function getArcbarDataPoints(e, t) {
  ...
  for (let o, n = 0; n < e.length; n++) {
    ...
    let i
    ;(i =
      'circle' == t.type ? 2 : t.endAngle < t.startAngle ? 2 + t.endAngle - t.startAngle : t.startAngle - t.endAngle),
...
function getGaugeDataPoints(e, t, a) {
  ...
  for (let n, l = 0; l < e.length; l++) {
    ...
    ;(n._endAngle_ = i * n.data + a.startAngle),
      ...
      (n._proportion_ =
        n.data >= a.oldData
          ? (n._endAngle_ - n._oldAngle_) * o + a.oldAngle
          : n._oldAngle_ - (n._oldAngle_ - n._endAngle_) * o),
  ...
  return e.map(function(e) {
    return null === e
      ...
      : ((e.width = Math.ceil((t - 2 * o.columePadding) / i)),
        n.extra.column &&
          n.extra.column.width &&
          0 < +n.extra.column.width &&
          (e.width = Math.min(e.width, +n.extra.column.width)),
        0 >= e.width && (e.width = 1),
...
function getYAxisTextList(e, t, a, o) {
  ...
  if (
    ...
    -1 < s
      ...
      : ('number' === typeof t.yAxis.min && (h = l(t.yAxis.min, h)),
        'number' === typeof t.yAxis.max && (x = r(t.yAxis.max, x))),
    h === x)
  ) {
    var c = x || 10
    x += c
...
function calYAxisData(e, t, a) {
  ...
  if (0 < l) {
    ...
    for (let e, x = 0; x < l; x++) {
      ;(e = t.yAxis.data[x]),
        !0 == t.yAxis.disabled && (e.disabled = !0),
        (s[x] = getYAxisTextList(r[x], t, a, n.type, x))
      let i = e.fontSize || a.fontSize
      ;(h[x] = { position: e.position ? e.position : 'left', width: 0 }),
        (d[x] = s[x].map(function(t) {
          return (
            (t = util.toFixed(t, 6)),
            (t = e.format ? e.format(+t) : t),
            (h[x].width = o(h[x].width, measureText(t, i) + 5)),
            t
          )
        }))
    ...
    ;(d[0] = s[0].map(function(e) {
      return (
        (e = util.toFixed(e, 6)),
        (e = t.yAxis.format ? t.yAxis.format(+e) : e),
        (h[0].width = o(h[0].width, measureText(e, i) + 5)),
        e
      )
    })),
...
function drawToolTipSplitArea(e, t, i, a, o) {
  var n = assign({}, { activeBgColor: '#000000', activeBgOpacity: 0.08 }, t.extra.tooltip),
    ...
    r = t.height - t.area[2]
  a.beginPath(),
    a.setFillStyle(hexToRgb(n.activeBgColor, n.activeBgOpacity)),
    a.rect(e - o / 2, l, o, r - l),
    a.closePath(),
    a.fill()
}
function drawToolTip(e, t, i, a, o) {
  var n = Math.round,
    ...
    d = 8 * i.pixelRatio,
    h = !1
  ;('line' == i.type || 'area' == i.type || 'candle' == i.type || 'mix' == i.type) &&
    drawToolTipSplitLine(i.tooltip.offset.x, i, a, o),
    (t = assign({ x: 0, y: 0 }, t)),
    (t.y -= 8 * i.pixelRatio)
...
function drawColumnDataPoints(e, t, i, a) {
  ...
  return (
    t._scrollDistance_ &&
      ...
      (h = Math.floor(-t._scrollDistance_ / r) - 2),
      (x = h + t.xAxis.itemCount + 4)),
    t.tooltip &&
      t.tooltip.textList &&
      t.tooltip.textList.length &&
      1 === o &&
      drawToolTipSplitArea(t.tooltip.offset.x, t, i, a, r),
...
function drawAreaDataPoints(e, t, i, a) {
  ...
  return (
    t._scrollDistance_ &&
      ...
      !0 === t.enableScroll &&
      (a.translate(t._scrollDistance_, 0),
      (x = -t._scrollDistance_ - s + t.area[3]),
      (c = x + (t.xAxis.itemCount + 4) * s)),
    e.forEach(function(e) {
      let l, p, g
      ...
      for (let o, l = 0; l < u.length; l++) {
        if (((o = u[l]), a.beginPath(), a.setStrokeStyle(hexToRgb(e.color, n.opacity)), n.gradient)) {
          ...
          i.addColorStop('0', hexToRgb(e.color, n.opacity)),
            i.addColorStop('1.0', hexToRgb('#FFFFFF', 0.1)),
            a.setFillStyle(i)
        ...
        if ((a.setLineWidth(n.width * t.pixelRatio), 1 < o.length)) {
          ...
          if ('curve' === n.type) {
            ...
            for (let e, t = 0; t < o.length; t++)
              (e = o[t]),
                0 == i && e.x > x && (a.moveTo(e.x, e.y), (i = 1)),
                0 < t && e.x > x && e.x < c && a.lineTo(e.x, e.y)
        ...
        if ((a.closePath(), a.fill(), n.addLine)) {
          ...
          if ((a.beginPath(), a.setStrokeStyle(e.color), a.setLineWidth(n.width * t.pixelRatio), 1 === o.length))
            ...
            if ('curve' === n.type) {
              ...
              for (let t, i = 0; i < o.length; i++)
                (t = o[i]),
                  0 == e && t.x > x && (a.moveTo(t.x, t.y), (e = 1)),
                  0 < i && t.x > x && t.x < c && a.lineTo(t.x, t.y)
            a.moveTo(o[0].x, o[0].y)
          }
...
function drawLineDataPoints(e, t, i, a) {
  ...
  return (
    t._scrollDistance_ &&
      ...
      !0 === t.enableScroll &&
      (a.translate(t._scrollDistance_, 0),
      (h = -t._scrollDistance_ - s + t.area[3]),
      (x = h + (t.xAxis.itemCount + 4) * s)),
    e.forEach(function(e) {
      let l, c, p
            ...
            if ('curve' === n.type) {
              ...
              for (let t, o = 0; o < e.length; o++)
                (t = e[o]),
                  ...
                  0 < o && t.x > h && t.x < x && a.lineTo(t.x, t.y)
            a.moveTo(e[0].x, e[0].y)
          }
        }),
        a.stroke(),
  ...
  if (
    ...
    e.forEach(function(e) {
      ...
      if ((d.push(S), 'column' == e.type)) {
        ...
        for (let o, n = 0; n < S.length; n++)
          if (((o = S[n]), null !== o && n > c && n < p)) {
            ...
            a.moveTo(T, o.y),
              a.moveTo(T, o.y),
              a.lineTo(T + o.width - 2, o.y),
              a.lineTo(T + o.width - 2, t.height - t.area[2]),
              a.lineTo(T, t.height - t.area[2]),
              a.lineTo(T, o.y),
              a.closePath(),
              a.stroke(),
              a.fill(),
        ...
        for (let n, l = 0; l < o.length; l++) {
          if (
            ...
            if ('curve' === e.style) {
              ...
              for (let e, t = 0; t < n.length; t++)
                (e = n[t]),
                  0 == i && e.x > g && (a.moveTo(e.x, e.y), (i = 1)),
                  0 < t && e.x > g && e.x < y && a.lineTo(e.x, e.y)
        ...
        _.forEach(function(i) {
          ...
          if ((a.beginPath(), a.setStrokeStyle(e.color), a.setLineWidth(2 * t.pixelRatio), 1 === i.length))
            ...
            if ('curve' == e.style) {
              ...
              for (let e, o = 0; o < i.length; o++)
                (e = i[o]),
                  0 == t && e.x > g && (a.moveTo(e.x, e.y), (t = 1)),
                  0 < o && e.x > g && e.x < y && a.lineTo(e.x, e.y)
            a.moveTo(i[0].x, i[0].y)
          }
          a.stroke(), a.setLineDash([])
        })
      ...
      'point' == e.type && (e.addPoint = !0),
        !0 == e.addPoint && 'column' !== e.type && drawPointShape(S, e.color, e.pointShape, a, t)
    }),
    !1 !== t.dataLabel && 1 === o)
  ) {
    var h = 0
    e.forEach(function(e) {
      ...
      'column' === e.type
        ? ((p = fixColumeData(p, r, x, h, i, t)), drawPointText(p, e, i, a), (h += 1))
  ...
  if (
    ...
    !0 === t.xAxis.calibration &&
      ...
      l.forEach(function(e, i) {
        0 < i &&
          (a.beginPath(), a.moveTo(e - d / 2, x), a.lineTo(e - d / 2, x + 3 * t.pixelRatio), a.closePath(), a.stroke())
      })),
    ...
    let n = e.length
    t.xAxis.labelCount &&
      ((n = t.xAxis.itemCount ? o((e.length / t.xAxis.itemCount) * t.xAxis.labelCount) : t.xAxis.labelCount), (n -= 1))
    let r = o(e.length / n),
      s = [],
      c = e.length
      ...
      if (
        (e.forEach(function(e, a) {
          ...
          o.beginPath(),
            ...
            'left' == r.position
              ? (o.fillText(e + '', x - r.width, l + i / 2),
                !0 == n.calibration && (o.moveTo(x, l), o.lineTo(x - 3 * t.pixelRatio, l)))
    ...
    l.forEach(function(e, o) {
      ...
      for (let n, l = 0; l < e.length; l++) {
        switch (
          ...
          case 'line':
            a.moveTo(y, f + 0.5 * p - 2 * t.pixelRatio),
              a.fillRect(y, f + 0.5 * p - 2 * t.pixelRatio, 15 * t.pixelRatio, 4 * t.pixelRatio)
            break
          case 'triangle':
          ...
          case 'diamond':
            ...
            break
          case 'circle':
            a.moveTo(y + 7.5 * t.pixelRatio, f + 0.5 * p),
              a.arc(y + 7.5 * t.pixelRatio, f + 0.5 * p, 5 * t.pixelRatio, 0, 2 * Math.PI)
            break
          case 'rect':
...
function drawPieDataPoints(e, t, a, o) {
  ...
  if (
    ...
    var x = 0.6 * d
    'number' === typeof t.extra.pie.ringWidth &&
      0 < t.extra.pie.ringWidth &&
      (x = Math.max(0, d - t.extra.pie.ringWidth)),
      o.beginPath(),
      o.setFillStyle(t.background || '#ffffff'),
      o.moveTo(s.x, s.y),
...
function drawArcbarDataPoints(e, t, i, a) {
  var o = Math.PI,
    ...
    l = assign(
      {},
      { startAngle: 0.75, endAngle: 0.25, type: 'default', width: 12 * t.pixelRatio, gap: 2 * t.pixelRatio },
      t.extra.arcbar
    )
...
function drawGaugeDataPoints(e, t, a, i, o) {
  ...
  if ('progress' == r.type) {
    ...
    for (let t, a = 0; a < e.length; a++)
      (t = e[a]),
        ...
        o.arc(s.x, s.y, d, t._startAngle_ * n, t._endAngle_ * n, !1),
        o.stroke()
  ...
  return (
    ...
    1 === l &&
      'gauge' === a.type &&
      ((a.extra.gauge.oldAngle = t[0]._proportion_), (a.extra.gauge.oldData = t[0].data)),
...
function drawRadarDataPoints(e, t, a, o) {
  var n = Math.cos,
    ...
    s = assign({}, { gridColor: '#cccccc', labelColor: '#666666', opacity: 0.2, gridCount: 3 }, t.extra.radar),
  ...
  for (var f = 0; f < d.length; f++) {
    ...
    for (var u = d[f].geometry.coordinates, m = 0; m < u.length; m++) {
      ...
      for (var S = 0; S < n.length; S++)
        (l = coordinateToPoint(n[S][1], n[S][0], h, p, g, y)),
          0 == S ? (o.beginPath(), o.moveTo(l.x, l.y)) : o.lineTo(l.x, l.y)
        ...
        ? 0 < l[n].areav[0] &&
          (t.tooltip
            ? t.tooltip.index == n
              ? a.strokeText(
                  e,
                  (l[n].areav[0] + 5 - t.width / 2) * o - (r * (1 - o)) / 2,
                  (l[n].areav[1] + 5 + i - t.height / 2) * o
                )
              : a.fillText(
                  e,
                  (l[n].areav[0] + 5 - t.width / 2) * o - (r * (1 - o)) / 2,
        ...
        : 0 < l[n].area[0] &&
          (t.tooltip
            ? t.tooltip.index == n
              ? a.strokeText(
                  e,
                  (l[n].area[0] + 5 - t.width / 2) * o - (r * (1 - o)) / 2,
                  (l[n].area[1] + 5 + i - t.height / 2) * o
                )
              : a.fillText(
                  e,
                  (l[n].area[0] + 5 - t.width / 2) * o - (r * (1 - o)) / 2,
...
function drawFunnelDataPoints(e, t, i, a) {
  ...
  return (
    a.restore(),
    !1 !== t.dataLabel && 1 === o && drawFunnelText(e, t, a, l, n.labelAlign, s, r),
    { center: r, radius: d, series: e }
  )
}
...
function Animation(e) {
  ;(this.isStop = !1),
    (e.duration = 'undefined' === typeof e.duration ? 1e3 : e.duration),
  ...
  var t = (function() {
    ...
    a = function(o) {
      if (null === o || !0 === this.isStop)
        return e.onProcess && e.onProcess(1), void (e.onAnimationFinish && e.onAnimationFinish())
...
function drawCharts(e, t, a, i) {
  ...
  if (t.enableScroll && 'right' == t.xAxis.scrollAlign && void 0 === t._scrollDistance_) {
    let e = 0,
      ...
      r = l * (i.length - 1)
    ;(e = n - a - r),
      (o.scrollOption = { currentOffset: e, startTouchX: e, distance: 0, lastMoveTime: 0 }),
      (t._scrollDistance_ = e)
  }
  switch (
    (('pie' === e || 'ring' === e || 'rose' === e) &&
      (a._pieTextMaxLength_ = !1 === t.dataLabel ? 0 : getPieTextMaxLength(s)),
    e)
  ) {
    case 'word':
        ...
        (this.animationInstance = new Animation({
          ...
          onProcess: function(e) {
            i.clearRect(0, 0, t.width, t.height),
              ...
              drawWordCloudDataPoints(n, t, a, i, e),
              drawCanvas(t, i)
          },
...
var Charts = function(e) {
  ...
  if (
    ...
    ('pie' == e.type || 'ring' == e.type) &&
      (t.pieChartLinePadding =
        !1 === e.dataLabel ? 0 : e.extra.pie.labelWidth * e.pixelRatio || t.pieChartLinePadding * e.pixelRatio),
    'rose' == e.type &&
      (t.pieChartLinePadding =
        !1 === e.dataLabel ? 0 : e.extra.rose.labelWidth * e.pixelRatio || t.pieChartLinePadding * e.pixelRatio),
  ...
  ;(t.yAxisWidth = config.yAxisWidth * e.pixelRatio),
    ...
    (e.$this = e.$this ? e.$this : this),
    (this.context = uni.createCanvasContext(e.canvasId, e.$this)),
    (e.chartData = {}),
...
;(Charts.prototype.updateData = function() {
  ...
  (Charts.prototype.zoom = function() {
    ...
    if (!0 !== this.opts.enableScroll)
      return void console.log('\u8BF7\u542F\u7528\u6EDA\u52A8\u6761\u540E\u4F7F\u7528\uFF01')
    let i =
      e(Math.abs(this.scrollOption.currentOffset) / this.opts.chartData.eachSpacing) + e(this.opts.xAxis.itemCount / 2)
